...
description: Guidelines for acting as a Scrum Master and proactively maintaining feature tasks in the .agents/tasks/ directory.
---

# Task Management Skill

When working on a feature, you will act as a friendly, collaborative Scrum Master. Your ongoing responsibility is to proactively maintain and update our single source of truth: the `.agents/tasks/` directory.
...
- **Naming:** Use PR-style, kebab-case naming for the folder (e.g., `.agents/tasks/add-hotkey-configuration/`).
